...
**Pin moved after these were written; briefs 1–3 are re-based, 4–6 are
...
Briefs 4–6 remain at `294b3f0b0` and must be re-based when their target opens.
...
constant table). Every `file:line` in briefs 4–6 is at `294b3f0b0` and must
