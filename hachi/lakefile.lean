...
lean_lib «HachiEquiv» where
  srcDir := "lean"
  roots := #[`Generated, `Field, `Ext, `NttArith, `GoldArith, `NttMath, `NttCRT, `NttStage, `NttTransform, `GoldStage, `GoldFusedStage, `GoldTransform, `GoldFusedBoundary, `NttProduct, `SumcheckShift, `SumcheckBucket, `Ring, `RingShort, `RingFused, `RingLimb, `RingTwoLane, `GoldDot, `RingSigned, `RqBridge, `Scheme, `SchemeTwoLane, `SchemeLimb, `Raw32, `ZPacked, `EvalSplit, `Balanced,
             `QuadEval, `QuadEvalProtocol, `RingSwitch, `ZeroCheck, `EndPiece, `Rlin, `Sumcheck,
             `Chain, `LiftGadget, `LiftProver, `OptFold, `OptZeroCheck, `OptSumcheck, `OptRingSwitch, `OptEvalSplit, `OptRingShort, `Opt, `Check]
