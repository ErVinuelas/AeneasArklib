...
lean_lib «HachiEquiv» where
  srcDir := "lean"
  roots := #[`Generated, `Field, `Ext, `NttArith, `GoldArith, `NttMath, `NttCRT, `NttStage, `NttTransform, `GoldStage, `GoldFusedStage, `GoldTransform, `NttProduct, `SumcheckShift, `Ring, `RingShort, `RingFused, `RingTwoLane, `GoldDot, `RqBridge, `Scheme, `Raw32, `EvalSplit, `Balanced,
