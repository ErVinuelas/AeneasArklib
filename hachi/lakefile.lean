...
lean_lib «HachiEquiv» where
  srcDir := "lean"
  roots := #[`Generated, `Field, `Ext, `NttArith, `GoldArith, `NttMath, `NttCRT, `NttStage, `NttTransform, `GoldStage, `GoldFusedStage, `GoldTransform, `GoldFusedBoundary, `NttProduct, `SumcheckShift, `Ring, `RingShort, `RingFused, `RingLimb, `RingTwoLane, `GoldDot, `RqBridge, `Scheme, `SchemeTwoLane, `SchemeLimb, `Raw32, `EvalSplit, `Balanced,
